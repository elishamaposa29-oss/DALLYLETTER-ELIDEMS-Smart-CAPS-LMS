    ...
    <KeyboardAvoidingView style={s.container} behavior="padding" keyboardVerticalOffset={0}>
      <View style={s.header}>
        ...
        <View style={s.headerText}>
          ...
          <Text style={s.headerSub}>Group conversation</Text>
        </View>
      </View>
          ...
          renderItem={({ item: msg }) => {
            ...
            return (
              <View style={{ alignItems: mine ? "flex-end" : "flex-start" }}>
                {!mine && <Text style={s.sender}>{msg.senderName ?? "Unknown"}</Text>}
      ...
      <View style={s.inputArea}>
        ...
        />
        <TouchableOpacity style={s.sendBtn} onPress={handleSend} disabled={!text.trim()}>
